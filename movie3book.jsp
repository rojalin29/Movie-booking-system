...
<body>
 ...
 <form action="payment.html">
        	...
        	<option value="friday">Friday, April 29th - 4:00 PM</option>
        	<option value="saturday">Saturday, April 30th - 1:00 PM</option>
        	<option value="sunday">Sunday, May 1st - 8:00 PM</option>
        	</select>
        	<br>
        </form>
